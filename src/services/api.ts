...
function loadInitialElderly(): ElderlyProfile {
 ...
 if (parsed && typeof parsed === 'object') return { ...def, ...parsed };
 }
 } catch {}
 return def;
}
...
function persistElderlyCache(eld: ElderlyProfile) {
 INITIAL_ELDERLY = { ...eld };
 try {
...
function loadInitialFamilies(): any[] {
 try {
...
let INITIAL_FAMILIES: any[] = loadInitialFamilies();

function persistFamiliesCache(fams: any[]) {
...
export const api = {
 ...
 elderly: import('../types').ElderlyProfile;
 message: string;
