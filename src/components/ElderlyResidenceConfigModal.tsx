...
import { MapPin, ShieldCheck, LocateFixed, Search, CheckCircle2, AlertCircle, X, Building2, Sliders, Navigation, Info, Compass, Loader2, } from "lucide-react";
...
export const ElderlyResidenceConfigModal: React.FC<ElderlyResidenceConfigModalProps> = ({
 ...
 <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-y-auto max-h-[calc(100dvh-1.5rem)] my-auto animate-in fade-in zoom-in-95 duration-200">
 {/* Header */}
